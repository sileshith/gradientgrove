    ...
    <div className="min-h-screen bg-grove-dark text-white">
      ...
      <div className="max-w-7xl mx-auto p-4 lg:p-6">
        ...
        <div className="hidden lg:grid grid-cols-2 grid-rows-2 gap-4 min-h-[80vh]">
          <Panel title="Pencil">{children.scratchpad}</Panel>
          <Panel title="Blocks">{children.blocks}</Panel>
          <Panel title="Code">{children.code}</Panel>
          <Panel title="SciML App">{children.sciml}</Panel>
        </div>
      </div>
    </div>
  );
