...
1. ✏️ **Pencil** — Hand-written math on grid canvas (think first!)
2. 🧩 **Blocks** — Drag-and-drop logic → Python code generation
3. 💻 **Code** — Monaco editor + Pyodide execution (real Python in browser)
4. 🚀 **SciML App** — Real scientific application (crop yield, gradient hiker, edge detection)
...
See `DEPLOY.md` for instructions. Deployed to Vercel at [learn.hirpadata.com](https://learn.hirpadata.com).
...
- [ ] User auth & progress tracking (Supabase)
